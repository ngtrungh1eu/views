<%-- 
    ...
    Created on : Feb 26, 2023, 11:13:05 AM
    Author     : ROG
--%>
                                                        ...
                                                        <form class="shop-w__form-p" method="POST" action="listProduct">
                                                            <div class="shop-w__form-p-wrap">
                                                                <div>
                                                                    ...
                                                                    <label for="price-min" name="minPrice" value=""></label>

                                                                    <input class="input-text input-text--primary-style" type="text" id="price-min" name="minPrice" value="" placeholder="Min"></div>
                                                                <div>

                                                                    <label for="price-max" name="maxPrice" value=""></label>

                                                                    <input class="input-text input-text--primary-style" type="text" id="price-max" name="maxPrice" value="" placeholder="Max"></div>
                                                                <div>
