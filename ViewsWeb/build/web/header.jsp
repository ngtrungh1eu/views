                    ...
                    <div class="container">
                        ...
                        <div class="secondary-nav">
                            ...
                            <div class="menu-init" id="navigation1">
                                ...
                                <button style="background-color: black" class="btn btn--icon toggle-mega-text toggle-button" type="button">M</button>
                                                    ...
                                                    <div class="mega-menu-list">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="home.jsp"><i class="fas fa-utensils u-s-m-r-6"></i>
...
<!--                                                <li class="has-dropdown has-dropdown--ul-left-100">
                                                    ...
                                                    <a href="index.html">Home<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                ...
                                                <li class="has-dropdown has-dropdown--ul-left-100">
                                                    ...
                                                    <a href="account.jsp">Dashboard<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                    ...
                                                    <ul style="width:200px">
                                                        <li class="has-dropdown has-dropdown--ul-left-100">
                                                            ...
                                                            <a href="account.jsp">Manage My Account<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
...
<!--                                                <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <li class="has-dropdown has-dropdown--ul-left-100">
                                                    ...
                                                    <a>Categories<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                    ...
                                                    <ul style="width:130px">
                                                        <li>
                                                            ...
                                                            <a href="shop-grid-left.html">Men</a></li>
                                                        <li>

                                                            <a href="shop-grid-right.html">Girl</a></li>
                                                        <li>

                                                            <a href="shop-grid-full.html">Việt Nam</a></li>
                                                        <li>

                                                            <a href="shop-side-version-2.html">Nước Ngoài</a></li>
                                                    </ul>
                                                    <!--====== End - Dropdown ======-->
                                                </li>
                                                <li class="has-dropdown has-dropdown--ul-left-100">

                                                    <a>All products<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
...
<!--                                                <li>
                                        ...
                                        <li class="has-dropdown">
                                            ...
                                            <a>BRAND<i class="fas fa-angle-down u-s-m-l-6"></i></a>
