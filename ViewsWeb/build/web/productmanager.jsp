<%@taglib prefix="sql" uri="http://java.sun.com/jsp/jstl/sql" %>
    <%-- Document : productmanager Created on : Mar 12, 2023, 2:29:52 PM Author : ACER --%>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="au-breadcrumb-content">
                                                ...
                                                <form class="au-form-icon--sm" action="SearchProductServlet"
                                                    method="POST">
                                                    <input class="au-input--w300 au-input--style2" type="text"
                                                        placeholder="Search product" name="txtSearchProduct">
                                                                    ...
                                                                    <div class="table-data-feature">
                                                                        ...
                                                                        <form class="item" action="product">
                                                                            ...
                                                                            <button class="item" data-toggle="tooltip"
                                                                                data-placement="top" name="action"
